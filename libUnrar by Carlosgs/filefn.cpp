...
#endif
#ifdef _UNIX
  /*BASTO*///chmod(Name,S_IRUSR|S_IWUSR|S_IXUSR);
#endif
}
...
#elif defined(_DJGPP)
  Success=1;//BASTO//_chmod(Name,1,Attr)!=-1;
#elif defined(_EMX)
  Success=1;//BASTO//__chmod(Name,1,Attr)!=-1;
#elif defined(_UNIX)
  Success=1;//BASTO//chmod(Name,(mode_t)Attr)==0;
#else
  Success=false;
#endif
  return(Success);
