...
int utf16le_mbtowc (ucs4_t *pwc, const unsigned char *s, int n);

int utf16le_to_utf8(unsigned char* dst, size_t count, unsigned short* str);
unsigned char* utf16le_to_utf8_alloc(unsigned short* str, int* size);
char* utf16le_to_utf8_old(const unsigned short* utf16le);
