...
extern OSL_IMAGE *oslLoadImageFilePNGfromMemory(FILE *f, int location, int pixelFormat);//carlosgs MOD
extern OSL_IMAGE *oslLoadImageFileJPGfromMemory(FILE *f, int location, int pixelFormat);//carlosgs MOD
